...
present. Where the chosen seat names a token variable that is unset, execution SHALL fail
naming it rather than spawning a worker that authenticates as something else.
